...
enum Constants {
    ...
    static let playerStartPosition: SIMD3<Float> = [0, 0, 0] // Start at the game world origin
    ...
    static let playerScale: Float = 0.001     // Uniform scale factor for the player
    static let laneScale: Float = 0.0001        // Uniform scale factor for lanes (adjust as needed)
    static let obstacleScale: Float = 0.001   // Uniform scale factor for obstacles (adjust as needed)
    ...
    static let gameTableYOffset: Float = 0.01 // Small offset to prevent Z-fighting or sinking
